...
PaymentAltID varchar(10) not null,
PaymentDate varchar(50),
PaymentDetail varchar(100)
)
go

Insert into DimPayment(PaymentAltID,PaymentDate,PaymentDetail)values
('PAY-001','1-1-2020','Payment for product detail 1'),
('PAY-002','2-1-2020','Payment for product detail 2'),
('PAY-003','3-1-2020','Payment for product detail 3'),
('PAY-004','4-1-2020','Payment for product detail 4'),
('PAY-005','5-1-2020','Payment for product detail 5');
Go
...
ShipmentDetail varchar(100)
)
go

SET IDENTITY_INSERT DimShipment ON;  
GO 
Insert into DimShipment(ShipmentID,ShipmentDate,ShipmentDetail)values
('SHP-001','10-1-2020','Shipment for product detail 1'),
('SHP-002','11-2-2020','Shipment for product detail 2'),
('SHP-003','12-3-2020','Shipment for product detail 3'),
('SHP-004','13-4-2020','Shipment for product detail 4'),
('SHP-005','14-5-2020','Shipment for product detail 5');
Go
...
AlTER TABLE FactProductSales ADD CONSTRAINT FK_PaymentKey FOREIGN KEY (PaymentID)REFERENCES Dimpayment(PaymentKey);
AlTER TABLE FactProductSales ADD CONSTRAINT FK_ShipmentKey FOREIGN KEY (ShipmentID)REFERENCES Dimshipment(ShipmentKey);
...
Insert into FactProductSales(SalesInvoiceNumber,SalesDateKey,SalesTimeKey,SalesTimeAltKey,StoreID,CustomerID,PaymentID,ShipmentID,ProductID ,SalesPersonID,Quantity,ProductActualCost,SalesTotalCost,Deviation)values
--1-jan-2015
...
(1,20130101,44347,121907,1,1,1,1,1,1,2,11,13,2),
(1,20130101,44347,121907,1,1,2,1,1,1,1,22.50,24,1.5),
(1,20130101,44347,121907,1,1,3,1,1,1,1,42,43.5,1.5),

(2,20130101,44519,122159,1,2,3,1,1,1,1,42,43.5,1.5),
(2,20130101,44519,122159,1,2,4,1,1,1,3,54,60,6),

(3,20130101,52415,143335,1,3,2,1,1,2,2,11,13,2),
(3,20130101,52415,143335,1,3,3,1,1,2,1,42,43.5,1.5),
(3,20130101,52415,143335,1,3,4,1,1,2,3,54,60,6),
(3,20130101,52415,143335,1,3,5,1,1,2,1,135,139,4),
--2-jan-2015
--SalesInvoiceNumber,SalesDateKey,SalesTimeKey,SalesTimeAltKey,StoreID,CustomerID,ProductID ,SalesPersonID,Quantity,ProductActualCost,SalesTotalCost,Deviation)
(4,20130102,44347,121907,1,1,1,2,2,1,2,11,13,2),
(4,20130102,44347,121907,1,1,2,2,2,1,1,22.50,24,1.5),

(5,20130102,44519,122159,1,2,3,2,2,1,1,42,43.5,1.5),
(5,20130102,44519,122159,1,2,4,2,2,1,3,54,60,6),

(6,20130102,52415,143335,1,3,2,2,2,2,2,11,13,2),
(6,20130102,52415,143335,1,3,5,2,2,2,1,135,139,4),

(7,20130102,44347,121907,2,1,4,2,2,3,3,54,60,6),
(7,20130102,44347,121907,2,1,5,2,2,3,1,135,139,4),

--3-jan-2015
--SalesInvoiceNumber,SalesDateKey,SalesTimeKey,SalesTimeAltKey,StoreID,CustomerID,ProductID ,SalesPersonID,Quantity,ProductActualCost,SalesTotalCost,Deviation)
(8,20130103,59326,162846,1,1,3,3,3,1,2,84,87,3),
(8,20130103,59326,162846,1,1,4,3,3,1,3,54,60,3),


(9,20130103,59349,162909,1,2,1,3,3,1,1,5.5,6.5,1),
(9,20130103,59349,162909,1,2,2,3,3,1,1,22.50,24,1.5),

(10,20130103,67390,184310,1,3,1,3,3,2,2,11,13,2),
(10,20130103,67390,184310,1,3,4,3,3,2,3,54,60,6),

(11,20130103,74877,204757,2,1,2,3,3,3,1,5.5,6.5,1),
(11,20130103,74877,204757,2,1,3,3,3,3,1,42,43.5,1.5)
Go
